...
Typically, the process of integrating an OpenID Provider comprises three steps.
...
It's possible to register multiple OpenID Providers with Site, and there are
