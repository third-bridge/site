...
action to create an identity and grant permission for the REPL user to call it.
...
[source,clojure]
----
include::../../dev/demo.clj[tag=create-action-get-identity!,indent=0]
----
====
...
[source,clojure]
----
include::../../dev/demo.clj[tag=grant-permission-for-mal-to-get-mal!,indent=0]
----

We can now test this in a browser. Navigate to https://site.test/~mal
====
