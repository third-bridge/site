...
[IMPORTANT]
--
Copy the code from <<example-put-user>> and paste it into an editor. Personalise
it according to your own user details. Copy the result into a REPL and evaluate
it.
--
