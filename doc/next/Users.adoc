...
<<example-put-user>> demonstrates how to create a user called "Malcolm Sparks".
...
[source,clojure]
----
include::../../dev/demo.clj[tag=install-user-identity!,indent=0]
----
====
...
[source,clojure]
----
include::../../dev/demo.clj[tag=install-subject!,indent=0]
----
====
