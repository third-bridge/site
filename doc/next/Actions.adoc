...
* Permissions are what restrict actions to specific users and applications via permissions.
* An action has rules which specify how permissions determine the outcome of authorization decisions.
