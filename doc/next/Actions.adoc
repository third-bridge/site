...
<6> This is a Rule. It ensures that the Action will be allowed only if there exists a Permission granting the User to invoke the Action. These concepts will be covered in <<ch-subjects>>. If you decide on a different data model for users, then this Rule will have to be modified to reflect that.
